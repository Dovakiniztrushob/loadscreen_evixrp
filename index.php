...
$slots = '128';// Maxplayers on your Server
...
$rules = array(
      ...
      "РДМ - полностью запрещен",
      "Читы - полностью запрещены, бан навсегда",
      "Эксплоиты - запрещены, хоть у нас и нет BackDoor`ов но бан вы все равно получите!" // Last one without comma
...
$scriptowner = '76561198332686092';

/* Enter Below your Admin Team ID's */

$owner = '76561198332686092'; // Enter your ID
$ownertitle = 'Owner'; 
...
$staff = [
          ...
          '76561198332686092' => 'Разработчик',
		  '2758445868484' => 'Спонсор'
